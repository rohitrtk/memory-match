...
import Card, { ICard, Images as cardImages, Audio as cardAudio } from "./../Card/Card";
...
const Game = () => {
  ...
  // Check if the first choice and second choice are a match
  useEffect(() => {
  ...
  // Updates the score each time the streak updates
  useEffect(() => {
    setScore((score) => score + 100 * streak);
  }, [streak])
